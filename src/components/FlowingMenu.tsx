...
function FlowingMenu({
  ...
  textColor = '#fff',
  bgColor = '#060A18',
  marqueeBgColor = '#00f0ff',
  marqueeTextColor = '#060A18',
...
function MenuItem({
  ...
  return (
    <div className={`menu__item${isActive ? ' menu__item--active' : ''}`} ref={itemRef} style={{ borderColor }}>
      <a
      ...
      >
        {isActive && <span className="menu__active-dot" />}
        {text}
      </a>
